...
export async function runChat(
  ...
  try {
    ...
    //new code
    const availableSkills = SkillsStore.listAvailable();
    ...
    If one of these skills is relevant to the user's request, call activate_skill with the skill name to load its full instructions before continuing.
    `
         : '';
    const systemPromptWithSkills = `${systemPropmt}
